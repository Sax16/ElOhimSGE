...
(function () {
  const I = (paths, opts) => (props) =>
    React.createElement(
      "svg",
      Object.assign(
        { viewBox: "0 0 24 24", fill: opts && opts.fill ? "currentColor" : "none", stroke: opts && opts.fill ? "none" : "currentColor",
          strokeWidth: 1.8, strokeLinecap: "round", strokeLinejoin: "round", width: "1em", height: "1em" },
        props
      ),
  ...
  const Raw = (children) => (props) =>
    React.createElement("svg", Object.assign({ viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.8, strokeLinecap: "round", strokeLinejoin: "round", width: "1em", height: "1em" }, props),
      React.createElement("g", { dangerouslySetInnerHTML: { __html: children } }));

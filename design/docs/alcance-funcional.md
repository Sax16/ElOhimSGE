...
- **"Logro del bimestre"** = promedio de competencias (AD=4…C=1, redondeo half-up) **ajustable por el docente** (queda marcado como ajustado; puede volver al automático). "Condición": promedio ≥2.5 Logrado · ≥1.5 En proceso · resto En inicio.
